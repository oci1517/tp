#################################
Dictionnaires et analyse de texte (v2)
#################################

Informations
============

*  Délai : vendredi 22 avril 23h59
...
``word_freq(text) --> None`` qui affiche
...
``draw_frequencies(freqs) --> None`` qui prend un dictionnaire de fréquences
de longueur raisonnable et affiche un diagramme de fréquence dans ``GPanel``.
